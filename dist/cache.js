...
import { isRecord, readBoolean, readNonEmptyString, readNonNegativeNumber, readPositiveInt, readStringArray, } from "./validation.js";
...
export function cacheFileName(identity) {
 ...
 */
export function serializeCachedModels(models) {
...
export class DiskCache {
    ...
    async write(identity, models, fetchedAt) {
        const path = this.pathFor(identity);
        const payload = {
            version: CACHE_VERSION,
            adapter: identity.adapter,
            ...
            baseURL: identity.baseURL,
            fetchedAt,
            models: serializeCachedModels(models),
        };
